...
config.seed = 1
fs = []
# fs.append('/home/abrar/cross_section_rl/data/cross_section_data/sphere_10verts_10sections.npz')
...
env = gym.make('simple_cross_section_env_weighted_local-v0', input_files=fs, same_obs_size=False, \
     k_state_neighborhood=2, previous_mesh_neighborhood=2, next_mesh_neighborhood=2, reward_type=REWARD_TYPE, noise=NOISE)
